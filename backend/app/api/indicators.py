...
def _dict_to_indicator_value(d: Dict[str, Any]) -> IndicatorValue:
    ...
    return IndicatorValue(
        ...
        cci_band_upper=float(d['cci_band_upper']) if d.get('cci_band_upper') is not None else None,
        cci_band_lower=float(d['cci_band_lower']) if d.get('cci_band_lower') is not None else None,
        mfi_upper=float(d['mfi_upper']) if d.get('mfi_upper') is not None else None,
        mfi_lower=float(d['mfi_lower']) if d.get('mfi_lower') is not None else None,
        mfi_cross_above=bool(d['mfi_cross_above']) if d.get('mfi_cross_above') is not None else None,
        mfi_cross_below=bool(d['mfi_cross_below']) if d.get('mfi_cross_below') is not None else None,
